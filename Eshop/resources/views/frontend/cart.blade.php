                ...
                @foreach ($cartitems as $item)
                    <div class="row product_data">
                        ...
                        <div class="col-md-3">
                            ...
                            @if ($item->products->qty >= $item->prod_qty)
                                ...
                                <div class="input-group text-center mb-3" style="width: 130px;">
                                    <button class="input-group-text  cheingQuantity decrement-but">-</button>
                                    <input type="text" name="quantity" class="form-control qty-input text-center"
                                        value="{{ $item->prod_qty }}">
                                    <button class="input-group-text  cheingQuantity increment-but">+</button>
                                </div>
                        ...
                        <div class="col-md-2 my-4">
                            <button class="btn btn-danger delete-cart-itme"><i class="fa fa-trash"></i> Remove</button>
                        </div>
                    </div>
                @endforeach
            </div>
